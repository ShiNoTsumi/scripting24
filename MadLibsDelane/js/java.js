...
function writeOne(){
    ...
    document.getElementById('outputone').innerHTML = name+" is stranded within a dense spralling jungle with nothing but the clothes on thier back and their closest possesion, a "+poss+". This "+poss+" is worth more to them than anything. Will they be able to survive within this hostile and unfamiliar envioroment and keep their only possesion close? Not knowing what could be out there, "+name+" begins exploring the jungle, looking for something to defend themselves. What could they hope to find in this jungle and what would be the next priority?";
