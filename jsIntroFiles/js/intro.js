...
document.getElementById("column2").innerHTML = "Javascript";

document.getElementById("column2").style.fontSize = "x-large";

document.getElementById("column2").style.alignContent = "center";

document.getElementById("column2").style.backgroundColor = "brown";
